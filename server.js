...
server.use(session({
    ...
    cookie: {
        ...
        sameSite: 'none' // <---- ഇത് 'none' എന്നാക്കി മാറ്റുക
    }
}));
...
// This is to confirm the server is live and handling requests correctly.
server.get('/', (req, res) => {
...
// Serving static files (images) from the Uploads directory
